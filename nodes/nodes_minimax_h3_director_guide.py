...
class MiniMaxH3DirectorFirstFrameGuide:
...
NODE_CLASS_MAPPINGS = {"MiniMaxH3DirectorFirstFrameGuide": MiniMaxH3DirectorFirstFrameGuide}
NODE_DISPLAY_NAME_MAPPINGS = {"MiniMaxH3DirectorFirstFrameGuide": "MiniMax H3 Director Guide (First Frame)"}